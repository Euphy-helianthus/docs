...
To Lock: Use the tool to pull the red adjustment wheel backward, lowering the foot pads and securing the printer to the floor.

To Unlock: Pull the wheel forward to raise the foot pads, enabling smooth movement.
